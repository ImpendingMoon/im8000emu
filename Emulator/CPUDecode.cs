...
internal partial class CPU
{
	...
	private void DecodeRType(ref DecodedOperation decodedOperation, ushort instructionWord)
	{
		...
		decodedOperation.Operation = operationSelector switch
		{
			...
			0b000001 => Constants.Operation.LEA,
			0b000010 => Constants.Operation.EX,
			0b000011 => Constants.Operation.ADD,
			0b000100 => Constants.Operation.ADC,
			0b000101 => Constants.Operation.SUB,
			0b000110 => Constants.Operation.SBC,
			0b000111 => Constants.Operation.CP,
			0b001000 => Constants.Operation.AND,
			0b001001 => Constants.Operation.OR,
			0b001010 => Constants.Operation.XOR,
			0b001011 => Constants.Operation.TST,
			0b001100 => Constants.Operation.BIT,
			0b001101 => Constants.Operation.SET,
			0b001110 => Constants.Operation.RES,
			0b001111 => Constants.Operation.RLC,
			0b010000 => Constants.Operation.RRC,
			0b010001 => Constants.Operation.RL,
			0b010010 => Constants.Operation.RR,
			0b010011 => Constants.Operation.SLA,
			0b010100 => Constants.Operation.SRA,
			0b010101 => Constants.Operation.SRL,
		...
		decodedOperation.DataSize = DecodeOperandSize(sizeSelector, instructionWord);
		...
		{
			Target = DecodeRegisterTarget(operand1Selector, decodedOperation.DataSize, instructionWord),
		};
		...
		else
		{
			decodedOperation.Operand2 = new Operand
			{
				Target = DecodeRegisterTarget(operand2Selector, decodedOperation.DataSize, instructionWord),
			};
		}
	}
	...
	private void DecodeRMType(ref DecodedOperation decodedOperation, ushort instructionWord)
	{
		...
		decodedOperation.Operation = operationSelector switch
		{
			...
			0b00001 => Constants.Operation.LEA,
			0b00010 => Constants.Operation.EX,
			0b00011 => Constants.Operation.ADD,
			0b00100 => Constants.Operation.ADC,
			0b00101 => Constants.Operation.SUB,
			0b00110 => Constants.Operation.SBC,
			0b00111 => Constants.Operation.CP,
			0b01000 => Constants.Operation.AND,
			0b01001 => Constants.Operation.OR,
			0b01010 => Constants.Operation.XOR,
			0b01011 => Constants.Operation.TST,
			0b01100 => Constants.Operation.BIT,
			0b01101 => Constants.Operation.SET,
			0b01110 => Constants.Operation.RES,
			0b01111 => Constants.Operation.RLC,
			0b10000 => Constants.Operation.RRC,
			0b10001 => Constants.Operation.RL,
			0b10010 => Constants.Operation.RR,
			0b10011 => Constants.Operation.SLA,
			0b10100 => Constants.Operation.SRA,
			0b10101 => Constants.Operation.SRL,
			0b10110 => Constants.Operation.IN_OUT,
			_ => throw new IllegalInstructionException(
				_currentOperation.BaseAddress,
				instructionWord,
		...
		{
			indirectOperand.Target = DecodeRegisterTarget(
				indirectOperandSelector,
		...
		{
			registerOperand.Target = DecodeRegisterTarget(
				registerOperandSelector,
				decodedOperation.DataSize,
				instructionWord
			);
		}
	...
	private void DecodeUMType(ref DecodedOperation decodedOperation, ushort instructionWord)
	{
		...
		{
			operand1.Target = DecodeRegisterTarget(operand1Selector, Constants.DataSize.DWord, instructionWord);
	...
	private void DecodeBType(ref DecodedOperation decodedOperation, ushort instructionWord)
	{
		...
		decodedOperation.Condition = DecodeCondition(conditionSelector, instructionWord);
	...
	private Constants.DataSize DecodeOperandSize(byte selector, ushort instructionWord)
	{
	...
	private Constants.RegisterTargets DecodeRegisterTarget(
		byte selector,
		Constants.DataSize size,
	...
	private Constants.Condition DecodeCondition(byte selector, ushort instructionWord)
	{
		return selector switch
		{
